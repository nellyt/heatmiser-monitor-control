	...
	<xsl:template match="/">
		...
		<xsl:for-each select="t:poll/t:controller">
			<tr>
				...
				<td title="sensormode">
                    <xsl:choose>
                        <xsl:when test="./t:sensormode = 0">IntAir</xsl:when>
                        <xsl:when test="./t:sensormode = 1">RemAir</xsl:when>
                        <xsl:when test="./t:sensormode = 2">Floor</xsl:when>
                        <xsl:when test="./t:sensormode = 3">IntAir+Floor</xsl:when>
                        <xsl:when test="./t:sensormode = 4">RemAir+Floor</xsl:when>
                        <xsl:otherwise>UNKNWON</xsl:otherwise>
                    </xsl:choose>
				</td>
				<td title="optimstart">
				...
				<td title="tempholdmins">
					<xsl:value-of select="./t:tempholdmins" />
				</td>
				<td title="remote">
					<xsl:choose>
